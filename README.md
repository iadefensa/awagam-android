...
* Block TLDs and domains at the DNS level
  ...
  - Compatible with AWAGAM browser extension blocklist format ([spec](https://codeberg.org/j9t/awagam#blocklist-format), [converter](https://hell.meiert.org/awagam/))
...
Uses [the same JSON format as the browser extension](https://codeberg.org/j9t/awagam#blocklist-format):
